...
public final class TodayModel {
    ...
    public func load() async {
        do {
            ...
            // cooperative: a reload already suspended past its last check runs to
            // completion unless it re-checks here, and would publish state for a
            // screen that is gone (see `stop()` and the ticker).
