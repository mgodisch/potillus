...
extension SettingsScreen {
    ...
    var backupSection: some View {
        Section {
            // FIRST ROW, NOT FOOTER. A Section footer is read after the last row,
            // so this sentence reached a listener behind Export and Import — after
            // the decision it exists to inform. Android carries it at the top of
            // the card. Footnote-sized, so the eye still takes it as a note.
            Text(Loc.string(
