...
entries here: tap an entry to edit it, or swipe it left to delete it. The Edit
button in the toolbar reveals a delete control too. Use the plus button to add
more beverages.
...
correct it, or swipe it left to delete it (the toolbar's Edit button offers the
same). It is also possible to add consumed beverages retroactively.
...
with a number of internationally common beverages. To modify or delete a
beverage, swipe its row left and choose Edit or Delete. You can define a new
beverage using the plus icon. Tapping a beverage opens a dialog to log it
directly as consumed.
