...
the app can be restricted using Face ID or Touch ID. Libellus Potionis supports you
...
The settings are reached from the menu button (☰) in the top-left corner.
...
3. Open **"Settings" → Backup → Import backup** and select
   that JSON file. Choose **Replace my data** to overwrite everything, or
