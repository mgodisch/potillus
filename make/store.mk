...
# icon, the GPLv3 logo and the pinned fonts. Every input is a prerequisite --
# over-approximated on purpose: an unnecessary rebuild is cheap, a MISSED
# dependency ships a stale asset.
...
# rasterize the graphic and the GPLv3 logo. $(1) is the message prefix.
