...
SKIP_BASENAMES = {
    "usersguide.md",          # generated by render-guide.py
    "copyright.md",           # generated by render-copyright.py
...
def iter_files(paths):
    """Yields every candidate file below the given paths."""
    for path in paths:
