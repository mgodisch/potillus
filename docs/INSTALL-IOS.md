...
above. It is the full local verification a contributor runs on a Mac; the GitLab
CI pipeline deliberately runs only the device-free subset (a hosted Linux runner
